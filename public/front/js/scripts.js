...
$(document).ready(function() {
	...
	var ut_word_rotator2 = function() {
		var ut_rotator_words2 = [
			'Поможем разработать бизнес-модель',
			'Нарисуем дизайн',
			'Воплотим задуманное в реальность'
		] ,
		counter = 0;
	...
	$('#contactform').submit(function(){
		...
		$("#message").slideUp(750, function()
        {
            ...
            $('#submit')
                .after('<img src="front/img/ajax-loader.gif" class="loader" />')
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.match('success') != null) document.getElementById('message').innerHTML = "<p class='lead'><strong>Спасибо.</strong><br>Мы получили Ваше сообщение и вскоре свяжемся с Вами.</p>";
